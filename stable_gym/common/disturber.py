"""This file contains a disturber class from which a gymnasium environment can inherit to
use it with the Robustness Evaluation tool of the Stable Learning Control package.
...
# See https://rickstaa.dev/stable-learning-control/utils/tester.html#robustness-eval-utility # noqa: E501
