...
class SwimmerCost(SwimmerEnv, utils.EzPickle):
    r"""Custom Swimmer gymnasium environment.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Initialise the SwimmerEnv class.
        super().__init__(
...
if __name__ == "__main__":
    ...
    env = gym.make("stable_gym:SwimmerCost", render_mode="human")
    ...
    s, _ = env.reset()
    path.append(s)
    print(f"\nPerforming '{EPISODES}' in the 'SwimmerCost' environment...\n")
    ...
    while episode + 1 <= EPISODES:
        ...
        if terminated or truncated:
            ...
            path.append(s)
            print(f"Episode: {episode}")
    print("\nFinished 'SwimmerCost' environment simulation.")
    ...
    for i in range(len(paths)):
        ...
        ax.set_title(f"SwimmerCost episode '{i+1}'")
        ax.legend()
