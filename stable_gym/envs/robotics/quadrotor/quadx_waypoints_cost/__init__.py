"""Modified version of the `QuadXWaypoints environment`_ found in the :PyFlyt:`PyFlyt package <>`.
...
:PyFlyt:`the PyFlyt documentation <>` or the accompanying` article of Tai et al. 2023`_
