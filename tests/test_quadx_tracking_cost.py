...
class TestQuadXTrackingCostEqual:
    # Make original QuadXHover environment.
    env = gym.make("PyFlyt.gym_envs:PyFlyt/QuadX-Hover-v0")
    # Make QuadXTrackingCost environment.
    env_cost = gym.make(
        "QuadXTrackingCost",
    )
    ...
    def test_snapshot(self, snapshot):
        ...
        env_cost = gym.make(
            "QuadXTrackingCost", exclude_reference_error_from_observation=False
